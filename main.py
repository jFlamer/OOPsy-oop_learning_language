...
def main():
    # Wczytaj kod z pliku
    with open("accessModifiersTest.oopsy", "rb") as f:
        content = f.read()
        print("Raw bytes:", content)

    with open("accessModifiersTest.oopsy", encoding="utf-8") as f:
        print("Text:\n", f.read())
    input_stream = FileStream("accessModifiersTest.oopsy", encoding='utf-8')
    ...
    # compile_oopsy_to_java("test.oopsy", "testJava.java")
